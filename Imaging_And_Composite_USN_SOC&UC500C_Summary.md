...
- 레지스터
  - ACC 레지스터(E0h) : <br> SU8051 내의 연산처리에 가장 많이 사용되는 레지스터 <br> 산술 논리 연산에서 연산자로 사용되고, table 참조 명령에서 table 번지의 오프셋으로도 사용되며, 외부 데이터 메모리와 데이터 전송에도 사용되고, 프로그램 메모리에서 데이터를 읽을 때도 사용 </br> </br>
